...
dest=$1
install -d "$dest/usr/share/zebra-raw" "$dest/usr/bin" "$dest/usr/share/applications" "$dest/usr/share/doc/zebra-raw" "$dest/usr/share/icons/hicolor/scalable/apps"
...
install -m 644 "$root/icons/zebra-raw.svg" "$dest/usr/share/icons/hicolor/scalable/apps/"
